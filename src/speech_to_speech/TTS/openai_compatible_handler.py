...
import httpx  # noqa: F401 - retained for existing transport test monkeypatches
import numpy as np
from hf_s2s_remote_speech import HttpSpeechOperation, SpeechRequestCancelled, SpeechRequestError
